...
import com.alibaba.rocketmq.tools.command.broker.BrokerConsumeStatsSubCommad;
...
import com.alibaba.rocketmq.tools.command.broker.SendMsgStatusCommand;
...
import com.alibaba.rocketmq.tools.command.message.CheckMsgSendRTCommand;
...
import com.alibaba.rocketmq.tools.command.message.QueryMsgByUniqueKeySubCommand;
...
import com.alibaba.rocketmq.tools.command.topic.AllocateMQSubCommand;
import com.alibaba.rocketmq.tools.command.topic.DeleteTopicSubCommand;
import com.alibaba.rocketmq.tools.command.topic.TopicClusterSubCommand;
...
import com.alibaba.rocketmq.tools.command.topic.UpdateTopicPermSubCommand;
...
public class MQAdminStartup {
	...
	public static void main0(String[] args, RPCHook rpcHook) {
		...
		try {
			 ...
			 * mqadmin使用方式:
			 * 1. mqadmin : 打印各个命令
			 * 2. mqadmin help <command>: 打印某个命令具体使用情况
			 * 3. mqadmin <command> <args>:使用某个命令
			 * </pre>
			 */
			switch (args.length) {
			case 0:
