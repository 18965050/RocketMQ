...
public class SubscriptionGroupManager extends ConfigManager {
	...
	public SubscriptionGroupConfig findSubscriptionGroupConfig(final String group) {
		...
		if (null == subscriptionGroupConfig) {
			if (brokerController.getBrokerConfig().isAutoCreateSubscriptionGroup()
				...
				SubscriptionGroupConfig preConfig = this.subscriptionGroupTable.putIfAbsent(group,
	...
	public String configFilePath() {
		// return
		// BrokerPathConfigHelper.getSubscriptionGroupPath(this.brokerController.getMessageStoreConfig().getStorePathRootDir());
		return BrokerPathConfigHelper
				.getSubscriptionGroupPath(System.getProperty("user.home") + File.separator + "store");
	}
