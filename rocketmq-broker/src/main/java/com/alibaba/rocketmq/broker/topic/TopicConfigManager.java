...
/**
 * 对应${user.home}/store/config/topics.json文件
 * 
 * @author lvchenggang
 *
 */
public class TopicConfigManager extends ConfigManager {
	...
	private final ConcurrentHashMap<String/* topicName */, TopicConfig> topicConfigTable = new ConcurrentHashMap<String, TopicConfig>(
			1024);
