...
public class BrokerStartup {
	...
	public static BrokerController createBrokerController(String[] args) {
		...
		if (null == System.getProperty(NettySystemConfig.SystemPropertySocketRcvbufSize)) {
			NettySystemConfig.socketRcvbufSize = 131072 /* 128k */;
		}
		...
		try {
			 ...
			 * <pre>
			 * broker支持的参数:
			 * -p: 打印brokerConfig,nettyServerConfig,nettyClientConfig,messageStoreConfig的参数信息
			 * -m: 打印brokerConfig,nettyServerConfig,nettyClientConfig,messageStoreConfig的重要参数信息
			 * -c: 将配置文件中的参数替换brokerConfig,nettyServerConfig,nettyClientConfig,messageStoreConfig中的值
			 * -n: namesrv地址
			 * </pre>
			 */
