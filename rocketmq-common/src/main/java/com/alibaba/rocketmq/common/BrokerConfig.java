...
public class BrokerConfig {
	...
	/**
	 * 消息发送线程池大小(SendMessageThread_i)
	 */
	private int sendMessageThreadPoolNums = 16 + Runtime.getRuntime().availableProcessors() * 4;

	/**
	 * 消息接收线程池大小(PullMessageThread_i)
	 */
	private int pullMessageThreadPoolNums = 16 + Runtime.getRuntime().availableProcessors() * 2;

	/**
	 * broker管理线程池大小, 比如broker配置修改, broker操作topic等(AdminBrokerThread_i)
	 */
	private int adminBrokerThreadPoolNums = 16;

	/**
	 * broker管理client线程池大小, 比如心跳, consumer信息获取等(ClientManageThread_i)
	 */
	...
	public static void main(String[] args) {
		System.out.println(PermName.PERM_READ | PermName.PERM_WRITE);
	}
}
