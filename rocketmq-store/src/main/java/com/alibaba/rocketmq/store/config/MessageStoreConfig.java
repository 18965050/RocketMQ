...
/**
 * 消息存储配置类. 对应commitLog,consumerQueue
 * 
 * @author lvchenggang
 *
 */
public class MessageStoreConfig {
	...
	@ImportantField
	private String storePathCommitLog = System.getProperty("user.home") + File.separator + "store" + File.separator
			+ "commitlog";
	...
	/**
	 * 每个indexFile的slot number
	 */
	private int maxHashSlotNum = 5000000;

	/**
	 * 每个indexFile存放index的总数
	 */
