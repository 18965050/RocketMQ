...
/**
 * <pre>
 * index 文件. 可根据message中的key定位到在commitlog中的位置
 * 文件由三部分组成:
 * IndexHeader: 默认40个字节
 * SlotTable: 默认每个slot table4个字节,总共500w个,一共是4*500w=2000w个字节
 * SlotTable中的key hash列表. 默认一共列表4个keyhash. 每个keyhash20个字节,因此所有keyhash大小为4*500w*20=40000w个字节
 * 总大小为40000w+2000w+40=420000040 个字节
 * </pre>
 * 
 * @author lvchenggang
 *
